...
public interface ProductControllerApi {
    ...
    @Operation(
            ...
            description = "Retorna todos os produtos cadastrados. Pode filtrar por categoria.",
            parameters = {
                    @Parameter(
                            name = "categoria",
    ...
    @GetMapping
    ResponseEntity<List<ProductResponseDto>> getAllProducts(@RequestParam(value = "categoria", required = false) String categoria);
